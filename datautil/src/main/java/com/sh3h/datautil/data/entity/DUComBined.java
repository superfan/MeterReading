...
public class DUComBined {
    ...
    public DUComBined(String _ch, String _cid, String _huming, String _dizhi, String _lianxidh, String _jianhao, String _biaohao, double _koujingmin, double _koujingmax, int _qianfeibs, double _qianfeije, long _huanbiaorq) {
        this._ch = _ch;
        this._cid = _cid;
