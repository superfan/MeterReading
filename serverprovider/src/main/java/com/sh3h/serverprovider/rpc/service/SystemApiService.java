...
//	}
	 ...
	 *            客户端信息
	 */
	public void keepAlive(KeepAliveInfoEntity aliveinfo) throws ApiException {
		try {
			this.call(SystemApiService.METHOD_KEEPALIVE,
	...
	public boolean feedBack(String content) throws ApiException {
		...
		try {
			result = this
					.callBoolean(SystemApiService.METHOD_FEEDBACK, content);
		} catch (ApiException e) {
