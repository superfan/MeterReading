 ...
 */
public class ChaoBiaoRWDao extends AbstractDao<ChaoBiaoRW, Void> {
    ...
    public static class Properties {
        ...
        public final static Property I_TongBuBZ = new Property(13, int.class, "I_TongBuBZ", false, "I_TONGBUBZ");
    }
    ...
    public ChaoBiaoRW readEntity(Cursor cursor, int offset) {
        ChaoBiaoRW entity = new ChaoBiaoRW( //
                ...
                cursor.isNull(offset + 13) ? 0 : cursor.getInt(offset + 13) // I_TongBuBZ
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, ChaoBiaoRW entity, int offset) {
        ...
        entity.setI_TongBuBZ(cursor.isNull(offset + 13) ? 0 : cursor.getInt(offset + 13));
    }
     ...
     */
    @Override
    protected Void updateKeyAfterInsert(ChaoBiaoRW entity, long rowId) {
     ...
     */
    @Override
    public Void getKey(ChaoBiaoRW entity) {
        return null;
    }
    ...
    public boolean insertData(ChaoBiaoRW chaoBiaoRW) {
        ...
        QueryBuilder qb = this.queryBuilder();
        qb.where(Properties.S_ChaoBiaoYBH.eq(chaoBiaoRW.getS_ChaoBiaoYBH()),
                Properties.I_RenWuBH.eq(chaoBiaoRW.getI_RenWuBH()),
                Properties.S_CH.eq(chaoBiaoRW.getS_CH()));
        ...
        if ((chaoBiaoRWList != null) && (chaoBiaoRWList.size() > 0)) {//再次从服务器下载任务时，更新已存在任务的总数、已抄数
            ...
            if (this.insertOrReplace(mChaoBiaoRW) == 0) {
                return false;
            } else {
                return true;
            }
    ...
    public void delectChaoBiaoRW(String account, int taskId, String ch) {
        if (account == null || ch == null) {
            return;
        }
...
//        QueryBuilder<ChaoBiaoRW> qb = this.queryBuilder();
//        DeleteQuery<ChaoBiaoRW> dq = qb.where(Properties.S_ChaoBiaoYBH.eq(account), Properties.I_RenWuBH.in(taskIds)).buildDelete();
//        dq.executeDeleteWithoutDetachingEntities();
    }
