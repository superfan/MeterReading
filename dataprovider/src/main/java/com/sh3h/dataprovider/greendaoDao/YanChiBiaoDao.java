 ...
 */
public class YanChiBiaoDao extends AbstractDao<YanChiBiao, Void> {
    ...
    public static class Properties {
        ...
        public final static Property I_CHAOJIANSL = new Property(4, Integer.class, "I_CHAOJIANSL", false, "I_CHAOJIANSL");
        ...
        public final static Property D_CHAOBIAORQ = new Property(10, Integer.class, "D_CHAOBIAORQ", false, "D_CHAOBIAORQ");
        ...
        public final static Property D_SHANGCICBRQ = new Property(16, Integer.class, "D_SHANGCICBRQ", false, "D_SHANGCICBRQ");
        ...
        public final static Property D_HUANBIAORQ = new Property(22, Integer.class, "D_HUANBIAORQ", false, "D_HUANBIAORQ");
        public final static Property D_HUANBIAOHTSJ = new Property(23, Integer.class, "D_HUANBIAOHTSJ", false, "D_HUANBIAOHTSJ");
        public final static Property D_DENGJISJ = new Property(24, Integer.class, "D_DENGJISJ", false, "D_DENGJISJ");
        ...
        public final static Property D_HUITIANSJ = new Property(28, Integer.class, "D_HUITIANSJ", false, "D_HUITIANSJ");
        ...
        public final static Property D_CAOZUOSJ = new Property(31, Integer.class, "D_CAOZUOSJ", false, "D_CAOZUOSJ");
    ...
    protected void bindValues(SQLiteStatement stmt, YanChiBiao entity) {
        ...
        if (I_CHAOJIANSL != null) {
            stmt.bindLong(5, I_CHAOJIANSL);
        }

        Integer I_SHANGCICM = entity.getI_SHANGCICM();
        if (I_SHANGCICM != null) {
            stmt.bindLong(6, I_SHANGCICM);
        }

        Integer I_CHAOHUICM = entity.getI_CHAOHUICM();
        if (I_CHAOHUICM != null) {
            stmt.bindLong(7, I_CHAOHUICM);
        }

        Integer I_ZHUANGTAIBM = entity.getI_ZHUANGTAIBM();
        if (I_ZHUANGTAIBM != null) {
            stmt.bindLong(8, I_ZHUANGTAIBM);
        }
        ...
        Integer I_LIANGGAOLDBM = entity.getI_LIANGGAOLDBM();
        if (I_LIANGGAOLDBM != null) {
            stmt.bindLong(10, I_LIANGGAOLDBM);
        }

        Integer D_CHAOBIAORQ = entity.getD_CHAOBIAORQ();
        if (D_CHAOBIAORQ != null) {
            stmt.bindLong(11, D_CHAOBIAORQ);
        }

        Integer I_CHAOBIAON = entity.getI_CHAOBIAON();
        if (I_CHAOBIAON != null) {
            stmt.bindLong(12, I_CHAOBIAON);
        }

        Integer I_CHAOBIAOY = entity.getI_CHAOBIAOY();
        if (I_CHAOBIAOY != null) {
            stmt.bindLong(13, I_CHAOBIAOY);
        }
        ...
        Integer I_FANGSHIBM = entity.getI_FANGSHIBM();
        if (I_FANGSHIBM != null) {
            stmt.bindLong(15, I_FANGSHIBM);
        }

        Integer I_CHAOBIAOZT = entity.getI_CHAOBIAOZT();
        if (I_CHAOBIAOZT != null) {
            stmt.bindLong(16, I_CHAOBIAOZT);
        }

        Integer D_SHANGCICBRQ = entity.getD_SHANGCICBRQ();
        if (D_SHANGCICBRQ != null) {
            stmt.bindLong(17, D_SHANGCICBRQ);
        }
        ...
        if (I_CENEIXH != null) {
            stmt.bindLong(20, I_CENEIXH);
        }

        Integer I_JIUBIAOCM = entity.getI_JIUBIAOCM();
        if (I_JIUBIAOCM != null) {
            stmt.bindLong(21, I_JIUBIAOCM);
        }

        Integer I_XINBIAODM = entity.getI_XINBIAODM();
        if (I_XINBIAODM != null) {
            stmt.bindLong(22, I_XINBIAODM);
        }

        Integer D_HUANBIAORQ = entity.getD_HUANBIAORQ();
        if (D_HUANBIAORQ != null) {
            stmt.bindLong(23, D_HUANBIAORQ);
        }

        Integer D_HUANBIAOHTSJ = entity.getD_HUANBIAOHTSJ();
        if (D_HUANBIAOHTSJ != null) {
            stmt.bindLong(24, D_HUANBIAOHTSJ);
        }

        Integer D_DENGJISJ = entity.getD_DENGJISJ();
        if (D_DENGJISJ != null) {
            stmt.bindLong(25, D_DENGJISJ);
        }

        Integer I_ZHUANGTAI = entity.getI_ZHUANGTAI();
        if (I_ZHUANGTAI != null) {
            stmt.bindLong(26, I_ZHUANGTAI);
        }
        ...
        if (D_CAOZUOSJ != null) {
            stmt.bindLong(32, D_CAOZUOSJ);
        }

        Integer I_HUANBIAOFS = entity.getI_HUANBIAOFS();
        if (I_HUANBIAOFS != null) {
            stmt.bindLong(33, I_HUANBIAOFS);
        }
        ...
        Integer I_ZHENSHICM = entity.getI_ZHENSHICM();
        if (I_ZHENSHICM != null) {
            stmt.bindLong(37, I_ZHENSHICM);
        }

        Integer I_LINYONGSLSM = entity.getI_LINYONGSLSM();
        if (I_LINYONGSLSM != null) {
            stmt.bindLong(38, I_LINYONGSLSM);
        }
        ...
        Integer I_YANCHILX = entity.getI_YANCHILX();
        if (I_YANCHILX != null) {
            stmt.bindLong(41, I_YANCHILX);
        }
        ...
        Integer I_CHAOBIAOBZ = entity.getI_CHAOBIAOBZ();
        if (I_CHAOBIAOBZ != null) {
            stmt.bindLong(43, I_CHAOBIAOBZ);
        }

        Integer I_ShangChuanBZ = entity.getI_ShangChuanBZ();
        if (I_ShangChuanBZ != null) {
            stmt.bindLong(44, I_ShangChuanBZ);
        }

        Integer I_KaiZhangBZ = entity.getI_KaiZhangBZ();
        if (I_KaiZhangBZ != null) {
            stmt.bindLong(45, I_KaiZhangBZ);
        }
        ...
        Integer I_LIANGGAOSL = entity.getI_LIANGGAOSL();
        if (I_LIANGGAOSL != null) {
            stmt.bindLong(47, I_LIANGGAOSL);
        }

        Integer I_LIANGDISL = entity.getI_LIANGDISL();
        if (I_LIANGDISL != null) {
            stmt.bindLong(48, I_LIANGDISL);
        }

        Integer I_PINGJUNL1 = entity.getI_PINGJUNL1();
        if (I_PINGJUNL1 != null) {
            stmt.bindLong(49, I_PINGJUNL1);
        }

        Integer I_SHANGCISL = entity.getI_SHANGCISL();
        if (I_SHANGCISL != null) {
            stmt.bindLong(50, I_SHANGCISL);
        }

        Integer N_JE = entity.getN_JE();
        if (N_JE != null) {
            stmt.bindLong(51, N_JE);
        }
    ...
    public YanChiBiao readEntity(Cursor cursor, int offset) {
        YanChiBiao entity = new YanChiBiao( //
                ...
                cursor.isNull(offset + 10) ? null : cursor.getInt(offset + 10), // D_CHAOBIAORQ
                ...
                cursor.isNull(offset + 16) ? null : cursor.getInt(offset + 16), // D_SHANGCICBRQ
                ...
                cursor.isNull(offset + 22) ? null : cursor.getInt(offset + 22), // D_HUANBIAORQ
                cursor.isNull(offset + 23) ? null : cursor.getInt(offset + 23), // D_HUANBIAOHTSJ
                cursor.isNull(offset + 24) ? null : cursor.getInt(offset + 24), // D_DENGJISJ
                ...
                cursor.isNull(offset + 28) ? null : cursor.getInt(offset + 28), // D_HUITIANSJ
                ...
                cursor.isNull(offset + 31) ? null : cursor.getInt(offset + 31), // D_CAOZUOSJ
    ...
    public void readEntity(Cursor cursor, YanChiBiao entity, int offset) {
        ...
        entity.setI_CHAOBIAOID(cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2));
        entity.setS_CID(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        entity.setI_CHAOJIANSL(cursor.isNull(offset + 4) ? null : cursor.getInt(offset + 4));
        entity.setI_SHANGCICM(cursor.isNull(offset + 5) ? null : cursor.getInt(offset + 5));
        entity.setI_CHAOHUICM(cursor.isNull(offset + 6) ? null : cursor.getInt(offset + 6));
        entity.setI_ZHUANGTAIBM(cursor.isNull(offset + 7) ? null : cursor.getInt(offset + 7));
        entity.setS_ZHUANGTAIMC(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
        entity.setI_LIANGGAOLDBM(cursor.isNull(offset + 9) ? null : cursor.getInt(offset + 9));
        entity.setD_CHAOBIAORQ(cursor.isNull(offset + 10) ? null : cursor.getInt(offset + 10));
        entity.setI_CHAOBIAON(cursor.isNull(offset + 11) ? null : cursor.getInt(offset + 11));
        entity.setI_CHAOBIAOY(cursor.isNull(offset + 12) ? null : cursor.getInt(offset + 12));
        entity.setS_CHAOBIAOY(cursor.isNull(offset + 13) ? null : cursor.getString(offset + 13));
        entity.setI_FANGSHIBM(cursor.isNull(offset + 14) ? null : cursor.getInt(offset + 14));
        entity.setI_CHAOBIAOZT(cursor.isNull(offset + 15) ? null : cursor.getInt(offset + 15));
        entity.setD_SHANGCICBRQ(cursor.isNull(offset + 16) ? null : cursor.getInt(offset + 16));
        ...
        entity.setI_CENEIXH(cursor.isNull(offset + 19) ? null : cursor.getInt(offset + 19));
        entity.setI_JIUBIAOCM(cursor.isNull(offset + 20) ? null : cursor.getInt(offset + 20));
        entity.setI_XINBIAODM(cursor.isNull(offset + 21) ? null : cursor.getInt(offset + 21));
        entity.setD_HUANBIAORQ(cursor.isNull(offset + 22) ? null : cursor.getInt(offset + 22));
        entity.setD_HUANBIAOHTSJ(cursor.isNull(offset + 23) ? null : cursor.getInt(offset + 23));
        entity.setD_DENGJISJ(cursor.isNull(offset + 24) ? null : cursor.getInt(offset + 24));
        entity.setI_ZHUANGTAI(cursor.isNull(offset + 25) ? null : cursor.getInt(offset + 25));
        ...
        entity.setD_HUITIANSJ(cursor.isNull(offset + 28) ? null : cursor.getInt(offset + 28));
        ...
        entity.setD_CAOZUOSJ(cursor.isNull(offset + 31) ? null : cursor.getInt(offset + 31));
        entity.setI_HUANBIAOFS(cursor.isNull(offset + 32) ? null : cursor.getInt(offset + 32));
        ...
        entity.setI_ZHENSHICM(cursor.isNull(offset + 36) ? null : cursor.getInt(offset + 36));
        entity.setI_LINYONGSLSM(cursor.isNull(offset + 37) ? null : cursor.getInt(offset + 37));
        ...
        entity.setI_YANCHILX(cursor.isNull(offset + 40) ? null : cursor.getInt(offset + 40));
        entity.setS_YANCHIBH(cursor.isNull(offset + 41) ? null : cursor.getString(offset + 41));
        entity.setI_CHAOBIAOBZ(cursor.isNull(offset + 42) ? null : cursor.getInt(offset + 42));
        entity.setI_ShangChuanBZ(cursor.isNull(offset + 43) ? null : cursor.getInt(offset + 43));
        entity.setI_KaiZhangBZ(cursor.isNull(offset + 44) ? null : cursor.getInt(offset + 44));
        entity.setS_JH(cursor.isNull(offset + 45) ? null : cursor.getString(offset + 45));
        entity.setI_LIANGGAOSL(cursor.isNull(offset + 46) ? null : cursor.getInt(offset + 46));
        entity.setI_LIANGDISL(cursor.isNull(offset + 47) ? null : cursor.getInt(offset + 47));
        entity.setI_PINGJUNL1(cursor.isNull(offset + 48) ? null : cursor.getInt(offset + 48));
        entity.setI_SHANGCISL(cursor.isNull(offset + 49) ? null : cursor.getInt(offset + 49));
        entity.setN_JE(cursor.isNull(offset + 50) ? null : cursor.getInt(offset + 50));
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(YanChiBiao entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(YanChiBiao entity) {
        return null;
    }
    ...
    public YanChiBiao getNextYanChiCB(String account, long ceneipx) {
        YanChiBiao yanChiBiao = null;
        QueryBuilder qb = this.queryBuilder();
        qb.where(Properties.S_CHAOBIAOY.eq(account),Properties.D_DENGJISJ.lt(ceneipx));
        qb.orderAsc(Properties.D_DENGJISJ);
        if (qb.list() == null){
            return null;
        }
        yanChiBiao = (YanChiBiao) qb.list().get(0);
    ...
    public YanChiBiao getPreviousYanChiCB(String account, long ceneipx) {
        YanChiBiao yanChiBiao = null;
        QueryBuilder qb = this.queryBuilder();
        qb.where(Properties.S_CHAOBIAOY.eq(account), Properties.D_DENGJISJ.gt(ceneipx));
        qb.orderAsc(Properties.D_DENGJISJ);
        if (qb.list() == null){
            return null;
        }
     ...
     * @return YanChiBiao实体
     */
    public YanChiBiao get(String cId) {
        QueryBuilder qb = this.queryBuilder();
        qb.where(Properties.S_CID.eq(cId));
        if (qb.list() == null){
            return null;
        }
        return (YanChiBiao) qb.list().get(0);
    }
