 ...
 */
public class DuoMeiTXXDao extends AbstractDao<DuoMeiTXX, Void> {
    ...
    public static class Properties {
        ...
        public final static Property I_RENWUBH = new Property(13, int.class, "I_RENWUBH", false, "I_RENWUBH");
        public final static Property S_ACCOUNT = new Property(14, String.class, "S_ACCOUNT", false, "S_ACCOUNT");
        public final static Property D_CREATERQ = new Property(15, long.class, "D_CREATERQ", false, "D_CREATERQ");
    }
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'CB_DuoMeiTXX' (" + //
                ...
                "'S_CH' TEXT," + // 12: S_CH
                "'I_RENWUBH' INTEGER," + // 13: I_RENWUBH
                "'S_ACCOUNT' TEXT," + // 14: S_ACCOUNT
                "'D_CREATERQ' INTEGER);"); // 15: D_CREATERQ
    }
    ...
    protected void bindValues(SQLiteStatement stmt, DuoMeiTXX entity) {
        ...
        stmt.bindLong(14, entity.getI_RENWUBH());

        String S_ACCOUNT = entity.getS_ACCOUNT();
        if (S_ACCOUNT != null) {
            stmt.bindString(15, S_ACCOUNT);
        }

        stmt.bindLong(16, entity.getD_CREATERQ());
    }
    ...
    public DuoMeiTXX readEntity(Cursor cursor, int offset) {
        DuoMeiTXX entity = new DuoMeiTXX( //
                ...
                cursor.isNull(offset + 13) ? 0 : cursor.getInt(offset + 13), // I_RENWUBH
                cursor.isNull(offset + 14) ? null : cursor.getString(offset + 14), // S_ACCOUNT
                cursor.isNull(offset + 15) ? 0 : cursor.getLong(offset + 15) // D_CREATERQ
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, DuoMeiTXX entity, int offset) {
        ...
        entity.setI_RENWUBH(cursor.isNull(offset + 13) ? 0 : cursor.getInt(offset + 13));
        entity.setS_ACCOUNT(cursor.isNull(offset + 14) ? null : cursor.getString(offset + 14));
        entity.setD_CREATERQ(cursor.isNull(offset + 15) ? 0 : cursor.getLong(offset + 15));
    }
     ...
     */
    @Override
    protected Void updateKeyAfterInsert(DuoMeiTXX entity, long rowId) {
     ...
     */
    @Override
    public Void getKey(DuoMeiTXX entity) {
        return null;
    }
...
//        bd.executeDeleteWithoutDetachingEntities();
        this.insertOrReplace(duoMeiTXX);
    }
    ...
    public List<DuoMeiTXX> getDuoMeiTXXList(String account, String cid,String ch,int renwuBH, int type) {
        if (account == null || cid == null || ch == null) {
            return null;
        }
...
//        }
    ...
    public boolean deleteDuoMeiTXX(String account, List<String> mediaList) {
        ...
        DeleteQuery<DuoMeiTXX> bd = qb.where(
                Properties.I_RENWUBH.in(mediaList),
    ...
    public void deleteDuoMeiTXX(String account, int renwubh, String ch) {
        ...
        DeleteQuery<DuoMeiTXX> bd = qb.where(
                ...
                Properties.I_RENWUBH.in(renwubh),
