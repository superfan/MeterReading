...
import com.sh3h.dataprovider.schema.ChaoBiaoRWColumns;
...
public class ChaoBiaoSJDao extends AbstractDao<ChaoBiaoSJ, Long> {
    ...
    public List<ChaoBiaoSJ> getList(int taskId,String cH, int sortType, List<String> cids) {
...
//                break;
    ...
    public ChaoBiaoSJ getNextChaoBiaoSJ(int taskId,String ch, long ceneixh) {
        ...
        QueryBuilder qb = this.queryBuilder();
        qb.where(Properties.S_CH.eq(ch), Properties.I_CENEIXH.gt(ceneixh),Properties.I_RenWuBH.eq(taskId));
        qb.orderAsc(Properties.I_CENEIXH);
        List<ChaoBiaoSJ> chaoBiaoSJList = qb.list();
        if ((chaoBiaoSJList == null) || (chaoBiaoSJList.size() <= 0)) {
            return null;
    ...
    public ChaoBiaoSJ getPreviousChaoBiaoSJ(int taskId,String ch, long ceneixh) {
        ...
        QueryBuilder qb = this.queryBuilder();
        qb.where(Properties.S_CH.eq(ch), Properties.I_CENEIXH.lt(ceneixh),Properties.I_RenWuBH.eq(taskId));
...
//        qb.buildDelete().executeDeleteWithoutDetachingEntities();
    ...
    private ChaoBiaoSJ analyze(Cursor cursor) {
        ...
        chaoBiaoSJ.setD_CHAOBIAORQ(Integer.valueOf(cursor.getInt(cursor
        ...
        chaoBiaoSJ.setD_SHANGCICBRQ(cursor.getInt(cursor
        ...
        chaoBiaoSJ.setD_HUANBIAORQ(cursor.getInt(cursor
        ...
        chaoBiaoSJ.setD_XIAZAISJ(cursor.getInt(cursor
        ...
        chaoBiaoSJ.setD_ZuiHouYCSCSJ(cursor.getInt(cursor
                .getColumnIndex(ChaoBiaoSJColumns.D_ZUIHOUYICSCSJ)));

        chaoBiaoSJ.setD_ZuiHouYCXZSJ(cursor.getInt(cursor
