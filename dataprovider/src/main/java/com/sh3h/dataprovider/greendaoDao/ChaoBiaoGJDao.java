...
public class ChaoBiaoGJDao extends AbstractDao<ChaoBiaoGJ, Void> {
    ...
    */
    public static class Properties {
        ...
        public final static Property D_CHAOBIAOSJ = new Property(3, int.class, "D_CHAOBIAOSJ", false, "D_CHAOBIAOSJ");
        public final static Property I_TYPE = new Property(4, int.class, "I_TYPE", false, "I_TYPE");
        public final static Property S_X = new Property(5, String.class, "S_X", false, "S_X");
        public final static Property S_Y = new Property(6, String.class, "S_Y", false, "S_Y");
        public final static Property S_ACCOUNT = new Property(7, String.class, "S_ACCOUNT", false, "S_ACCOUNT");
        public final static Property I_RENWUBH = new Property(8, int.class, "I_RENWUBH", false, "I_RENWUBH");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'CB_ChaoBiaoGJ' (" + //
                ...
                "'D_CHAOBIAOSJ' INTEGER NOT NULL ," + // 3: D_CHAOBIAOSJ
                "'I_TYPE' INTEGER NOT NULL ," + // 4: I_TYPE
                "'S_X' TEXT NOT NULL ," + // 5: S_X
                "'S_Y' TEXT NOT NULL," + // 6: S_Y
                "'S_ACCOUNT' TEXT NOT NULL," + //7: S_ACCOUNT
                "'I_RENWUBH' INTEGER NOT NULL );"); //
    }
    ...
    protected void bindValues(SQLiteStatement stmt, ChaoBiaoGJ entity) {
        ...
        stmt.bindLong(4, entity.getD_CHAOBIAOSJ());
        stmt.bindLong(5, entity.getI_TYPE());
        stmt.bindString(6, entity.getS_X());
        stmt.bindString(7, entity.getS_Y());
        stmt.bindString(8,entity.getS_ACCOUNT());
        stmt.bindLong(9, entity.getI_RENWUBH());
    }
    ...
    public ChaoBiaoGJ readEntity(Cursor cursor, int offset) {
        ChaoBiaoGJ entity = new ChaoBiaoGJ( //
            ...
            cursor.getInt(offset + 3), // D_CHAOBIAOSJ
            cursor.getInt(offset + 4), // I_TYPE
            cursor.getString(offset + 5), // S_X
            cursor.getString(offset + 6), // S_Y
            cursor.getString(offset + 7), // S_ACCOUNT
            cursor.getInt(offset + 8)//I_RENWUBH
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, ChaoBiaoGJ entity, int offset) {
        ...
        entity.setD_CHAOBIAOSJ(cursor.getInt(offset + 3));
        entity.setI_TYPE(cursor.getInt(offset + 4));
        entity.setS_X(cursor.getString(offset + 5));
        entity.setS_Y(cursor.getString(offset + 6));
        entity.setS_ACCOUNT(cursor.getString(offset + 7));
        entity.setI_RENWUBH(cursor.getInt(offset + 8));
     }
    ...
    public List<ChaoBiaoGJ> getChaoBiaoGJList(String account, int renwuBH, String ch) {
        ...
        QueryBuilder qb = this.queryBuilder();
        qb.where(Properties.S_ACCOUNT.eq(account),Properties.I_RENWUBH.eq(renwuBH),Properties.S_CH.eq(ch));
        List<ChaoBiaoGJ> chaoBiaoGJs = qb.list();
        return chaoBiaoGJs;
    }
