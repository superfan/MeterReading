...
//        Query query = queryRawCreate("left join JG_JianHao jh " +
//                "on T.S_JIANHAO=jh.S_JIANHAO " +
//                "left join JG_FeiYongZC fy " +
//                "on T.I_FEIYONGID = fy.I_FEIYONGID " +
//                "and T.I_TIAOJIAH = fy.I_TIAOJIAH " +
//                "where T.S_JIANHAO in (?) " +
//                "order by T.S_JIANHAO,T.I_JIETIJB,T.I_FEIYONGDLID", S_JH);
...
//        List<JianHaoMX> jianHaoMXList = qb.list();
