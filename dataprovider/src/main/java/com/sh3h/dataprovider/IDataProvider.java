...
public interface IDataProvider {
    ...
    public List<ChaoBiaoSJ> getListChaoBiaoSJ(int taskId,String cH, int sortType, List<String> cids);
    ...
    public ChaoBiaoSJ getNextChaoBiaoSJ(int taskId,String ch, long ceneixh);

    public List<ChaoBiaoSJ> getNextUnfinishedChaoBiaoSJWithCeNeiXH(int renWuBH, String ch);

    public ChaoBiaoSJ getPreviousChaoBiaoSJ(int taskId,String ch, long ceneixh);
...
//                                    double x1, double y1, int chaoBiaoBiaoZhi, String jieTiTS);
    ...
    public void insertChaoBiaoSJList(List<ChaoBiaoSJ> chaoBiaoSJList);
    ...
    public void deleteChaoBiaoSJ(String account, int renWuBH, String ch);
     ...
     * 删除表卡信息
     */
    public void delectBiaoKaXX(String cidAll);
     ...
     * 删除抄表记录
     */
    public void delectchaoBiaoJL(String cidAll);
     ...
     * 根据CID查询延迟表信息
     */
    public YanChiBiao getYanChiBiaoXX(String S_CID);
    ...
    public YanChiBiao getNextYanChiCB(String account, long ceneipx);

    public YanChiBiao getPreviousYanChiCB(String account, long ceneipx);
    ...
    public void updateDuoMeiTXX(DuoMeiTXX duoMeiTXX);
    ...
    public void deleteDuoMeiTXX(String account, int renwubh, String ch);

    public void deleteCHaoBiaoRW(String taskId, String account);

    public void deleteChaoBiaoRW(String account, int taskId, String ch);

    public void deleteChaoBiaoSJByTaskId(String account, String taskIdsArr);

    public void deleteChaoBiaoRWByTaskId(String account, String taskIdsArry);
